...
describe('NoteCard', () => {
  ...
  it('delete button calls onDelete after fade-out animation', () => {
  ...
  it('logs error to console when delete callback throws', () => {
    vi.useFakeTimers({ shouldAdvanceTime: true });
  ...
  it('renders Turkish date format', () => {
    ...
    // Locale Turkish date should contain the day number
    expect(date.textContent).toMatch(/26/);
  });
});
